...
import com.example.testviewpager.search.YoutubeSearchService
...
object RetrofitApi {
    ...
    val youtubeSearchService: YoutubeSearchService by lazy {
        retrofit.create(YoutubeSearchService::class.java)
    }
